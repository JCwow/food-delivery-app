...
const Filter = ({categories}: {categories: Category[]}) => {
    ...
    useEffect(() => {
        setActive(typeof searchParams.category === 'string' ? searchParams.category : '')
    ...
    const filterData: (Category | {$id: string, name: string})[] = categories ? [{$id: 'all', name: 'All'}, ...categories]
    : [{$id: 'all', name: 'All'}]
    return (
        <FlatList 
        data={filterData}
